...
public class BookDaoImpl implements BookDao {
    ...
    public boolean insertBook(Books arg0) {
        boolean f = false;
        try {
            String insert = "insert into books(bookName,author,price,bookCategory,status,photoName,email) values(?,?,?,?,?,?,?)";
    ...
    public List<Books> getAllBooks() {
        ...
        try {
            ...
            while (set.next()) {
                ...
                b.setPhotoName(set.getString("photoName"));
    ...
    public Books getBookById(Integer arg0) {
        Books b = new Books();
        try {
            String booksList = "select * from books where bookId = ?";
            PreparedStatement ps = con.prepareStatement(booksList);
            ps.setInt(1, arg0);
            ResultSet set = ps.executeQuery();
            while (set.next()) {
    ...
    public boolean updateBook(Books arg0) {
        boolean f = false;
        try {
            String update = "update books set bookName = ?,status=?,price=?,author=? where bookId = ?";
    ...
    public List<Books> getNewBooks() {
        ...
        Books b = null;
        try {
            String query = "select * from books  where bookCategory = ? and status=? order by bookId DESC";
    ...
    public List<Books> getRecentBooks() {
        ...
        Books b = null;
        try {
            String query = "select * from books  where status=? order by bookId DESC";
            PreparedStatement ps = con.prepareStatement(query);
    ...
    public boolean deleteUseOldBook(String arg0, String arg1, Integer arg2) {
        boolean b = false;
        try {
            String delete = "delete from books where email=? and bookCategory=? and bookId=?";
            PreparedStatement ps = con.prepareStatement(delete);
            ps.setString(1, arg0);
            ps.setString(2, arg1);
            ps.setInt(3, arg2);
    ...
    public List<Books> getBookBySearch(String arg0) {
        ...
        Books b = null;
        try {
            String query = "select * from books  where bookName like ? or author like ? or bookCategory like ? and status=?";
            PreparedStatement ps = con.prepareStatement(query);
            ps.setString(1, "%" + arg0 + "%");
            ps.setString(2, "%" + arg0 + "%");
            ps.setString(3, "%" + arg0 + "%");
