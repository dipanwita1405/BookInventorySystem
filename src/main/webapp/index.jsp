    ...
    <body style="background-color: #f0f1f2">
        ...
        <div class="container">
                    ...
                    <div class="card crd-ho">
                        <div class="card-body text-center">
                            ...
                            <div class="row text-center">
                                ...
                                %>
                                <a href="Cart?bid=<%= book1.getBookId()%>&uid=<%= u.getUserId()%>" class="btn btn-danger btn-sm ml-3"><i class="fa-solid fa-cart-plus"></i> Add Cart</a>
                                <%
                                    }
                                %>
            ...
            <div class="text-center mt-1">
                <a href="all_recent_books.jsp" class="btn btn-info btn-block text-white">View All</a>
            </div>
        </div>
        <!--end recent book-->
        <hr>
        ...
        <div class="container">
                    ...
                    <div class="card crd-ho">
                        <div class="card-body text-center">
                            ...
                            <div class="row">
                                ...
                                %>
                                <a href="Cart?bid=<%= books.getBookId()%>&uid=<%= u.getUserId()%>" class="btn btn-danger btn-sm ml-3"><i class="fa-solid fa-cart-plus"></i> Add Cart</a>
                                <%
                                    }
                                %>
            ...
            <div class="text-center mt-1">
                <a href="all_new_books.jsp" class="btn btn-info btn-block text-white">View All</a>
            </div>
        </div>
        <!--end new book-->
        <hr>
        ...
        <div class="container">
            ...
            <div class="text-center mt-1">
                <a href="all_old_books.jsp" class="btn btn-info btn-block text-white"> View All</a>
            </div>
        </div>
        <!--end old book-->
